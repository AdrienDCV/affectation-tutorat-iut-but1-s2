...
class FirstYearStudentTest {
	...
	@BeforeEach
	 public void initialization() {
		...
		f2 = new FirstYearStudent("DA COSTA VEIGA", "Adrien", LocalDate.of(2003, 5, 25), 1, 'F', null, 0, new HashMap<Subject, Double>());
		...
		f5 = new FirstYearStudent("DA COSTA VEIGA", "Adrien", LocalDate.of(2003, 5, 25), "adrien.dacostaveiga.etu","passwd","dacostaveiga.etu@univ-lille.fr", 1, 'F', Motivation.HIGH_MOTIVATION, 0, new HashMap<Subject, Double>());
