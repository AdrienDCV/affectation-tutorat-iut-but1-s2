...
public class UseAffectation {
	...
	public static void display(List<Arete<Student>> liste) {
		   ...
		   for(int i=0; i<liste.size(); i++) {
			   System.out.println(liste.get(i).getExtremite1().getName() + " " + liste.get(i).getExtremite1().getForename() + " est affectÈ(e) ‡ : " + liste.get(i).getExtremite2().getName() + " " + liste.get(i).getExtremite2().getForename());
		   }
	}
	...
	public static void main(String[] args) {
		...
		Student Honore = new FirstYearStudent("MARTEL", "HonorÈ", LocalDate.of(2001, 11, 11), 1, 'D', Motivation.LOW_MOTIVATION, 1, Hgrades);
