...
class ThirdYearStudentTest {
	...
	@BeforeEach
	 public void initialization() {
		...
		s2 = new ThirdYearStudent("DA COSTA VEIGA", "Adrien", LocalDate.of(2003, 5, 25), 3, 'F', Motivation.HIGH_MOTIVATION, 0, new HashMap<Subject, Double>(), true);
		s3 = new ThirdYearStudent("DA COSTA VEIGA", "Adrien", LocalDate.of(2003, 5, 25), "adrien.dacostaveiga.etu","passwd","adrien.dacostaveiga.etu@univ-lille.fr", 3, 'F', Motivation.HIGH_MOTIVATION, 0, new HashMap<Subject, Double>(), true);
